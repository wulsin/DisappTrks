...
for runPeriod in runPeriods:
    ...
    if background == "ELECTRON" or background == "LEPTON" or background == "ALL":
        ...
        if combineLayers:
            ...
            print("********************************************************************************")
            print("performing electron background estimate in search region(2022", runPeriod, "-- combined layers bins)")
            print("--------------------------------------------------------------------------------")

            fout = TFile.Open("electronBkgdEstimate_2022" + runPeriod + "_combinedBins.root", "recreate")
